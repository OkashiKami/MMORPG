...
public class UIProgressBar : UIWidgetContainer
{
	...
	[HideInInspector][SerializeField] protected View mBG;
	[HideInInspector][SerializeField] protected View mFG;
	...
	public View foregroundWidget { get { return mFG; } set { if (mFG != value) { mFG = value; mIsDirty = true; } } }

	/// <summary>
	/// Widget used for the background.
	/// </summary>

	public View backgroundWidget { get { return mBG; } set { if (mBG != value) { mBG = value; mIsDirty = true; } } }
	...
	public float alpha
	{
		...
		set
		{
			...
			if (thumb != null)
			{
				View w = thumb.GetComponent<View>();
