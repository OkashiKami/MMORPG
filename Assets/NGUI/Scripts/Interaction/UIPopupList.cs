...
public class UIPopupList : UIWidgetContainer
{
	...
	public virtual void CloseSelf ()
	{
		if (mChild != null && current == this)
		{
			...
			if (isAnimated)
			{
				View[] widgets = mChild.GetComponentsInChildren<View>();
	...
	protected virtual void AnimateColor (View widget)
	{
	...
	protected virtual void AnimatePosition (View widget, bool placeAbove, float bottom)
	{
	...
	protected virtual void AnimateScale (View widget, bool placeAbove, float bottom)
	{
		GameObject go = widget.gameObject;
	...
	protected void Animate (View widget, bool placeAbove, float bottom)
	{
		AnimateColor(widget);
	...
	public virtual void Show ()
	{
		if (enabled && NGUITools.GetActive(gameObject) && mChild == null && isValid && items.Count > 0)
		{
			...
			mBackground.pivot = View.Pivot.TopLeft;
			...
			mHighlight.pivot = View.Pivot.TopLeft;
