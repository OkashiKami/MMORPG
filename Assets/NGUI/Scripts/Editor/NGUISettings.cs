...
#region Convenience accessor properties
	...
	static public View.Pivot pivot
	{
		get { return GetEnum("NGUI Pivot", View.Pivot.Center); }
	...
	static public View AddWidget (GameObject go)
	{
		View w = NGUITools.AddWidget<View>(go);
		w.name = "Container";
		w.pivot = pivot;
		w.width = 100;
		w.height = 100;
	...
	static public void CopyWidget (View widget)
	{
	...
	static public void PasteWidget (View widget, bool fully)
	{
		widget.color = GetColor("Widget Color", widget.color);
		widget.pivot = GetEnum<View.Pivot>("Widget Pivot", widget.pivot);
