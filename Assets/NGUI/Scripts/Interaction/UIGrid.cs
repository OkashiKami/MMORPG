...
public class UIGrid : UIWidgetContainer
{
	...
	public View.Pivot pivot = View.Pivot.TopLeft;
	...
	protected virtual void ResetPosition (List<Transform> list)
	{
		...
		for (int i = 0, imax = list.Count; i < imax; ++i)
		{
			...
			if (animateSmoothly && Application.isPlaying && (pivot != View.Pivot.TopLeft || Vector3.SqrMagnitude(t.localPosition - pos) >= 0.0001f))
			{
