...
public class UIPanelTool : EditorWindow
{
	...
	static void GetWidgets (Transform t, List<View> widgets)
	{
		for (int i = 0; i < t.childCount; ++i)
		{
			Transform child = t.GetChild(i);
			View w = child.GetComponent<View>();
	...
	static List<View> GetWidgets (UIPanel panel)
	{
		List<View> widgets = new List<View>();
