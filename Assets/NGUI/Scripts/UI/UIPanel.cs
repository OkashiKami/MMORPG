...
public class UIPanel : UIRect
{
	...
	public List<View> widgets = new List<View>();
	...
	public delegate Material OnCreateMaterial (View widget, Material mat);
    ...
    [HideInInspector] [SerializeField] string mID = string.Empty;
	...
	{
		mSortWidgets = false;
		widgets.Sort(View.PanelCompareFunc);
	}
	...
	public UIDrawCall FindDrawCall (View w)
	{
		var mat = w.material;
	...
	public void AddWidget (View w)
	{
		...
		else if (View.PanelCompareFunc(w, widgets[0]) == -1)
		{
			widgets.Insert(0, w);
		}
		else
		{
			...
			{
				if (View.PanelCompareFunc(w, widgets[--i]) == -1) continue;
	...
	public void RemoveWidget (View w)
	{
