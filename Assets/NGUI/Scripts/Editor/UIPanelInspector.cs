...
public class UIPanelInspector : UIRectEditor
{
	...
	public void OnSceneGUI ()
	{
		...
		View.Pivot pivotUnderMouse = UIWidgetInspector.GetPivotUnderMouse(handles, e, resizable, true, ref actionUnderMouse);
	...
	void AdjustClipping (UIPanel p, Vector3 startLocalPos, Vector4 startCR, Vector3 worldDelta, View.Pivot pivot)
	{
