...
[Serializable]
public class ViewDispaly
{
    [HideInInspector] public string name;
    public View view;

    public ViewDispaly(View view)
    {
        name = view.id;
        this.view = view;
    }
...
public class View : UIRect
{
    ...
    [HideInInspector] [SerializeField] protected String mID = string.Empty;
	...
	[HideInInspector][SerializeField] internal int mHeight = 100;
	[HideInInspector][SerializeField] internal int mDepth = 0;
	...
	public delegate void OnPostFillCallback (View widget, int bufferOffset, List<Vector3> verts, List<Vector2> uvs, List<Color> cols);
	...
	static public int FullCompareFunc (View left, View right)
	{
	...
	[System.Diagnostics.DebuggerHidden]
	[System.Diagnostics.DebuggerStepThrough]
	static public int PanelCompareFunc (View left, View right)
	{
	...
	protected override void OnStart ()
	{
		...
		else if (!Application.isPlaying && GetComponents<View>().Length > 1)
		{
